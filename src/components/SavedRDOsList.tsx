...
interface SavedRDOsListProps {
  ...
  // This will be used to refresh the list from the parent
  // when a new draft is saved in the form.
...
export const SavedRDOsList = ({ onOpenDraft, refreshTrigger }: SavedRDOsListProps) => {
  ...
  const [isUploading, setIsUploading] = useState<string | null>(null); // Holds the ID of the draft being uploaded
              ...
              <li key={draft.id} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={isUploading === draft.id || !navigator.onLine}
                  >
